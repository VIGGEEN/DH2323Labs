...
public class RadarAlarm : MonoBehaviour
{
    ...
    {
        // An object entered, check if it is the player tank
        if(!other.CompareTag("Player")) return;
        
        // Trigger the alarm by changing material
    ...
    {
		// An object exited, check if it is the player tank
        if(!other.CompareTag("Player")) return;
        
        // Reset the alarm by changing material
        lineRenderer.material = Resources.Load<Material>("Materials/Save");
